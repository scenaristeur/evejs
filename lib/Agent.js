...
console.warn("+++++++++++++++++++agent send", to, message)
  ...
  console.warn('--------------------Agent default connection', to, conn);
  if (conn) {
...
Agent.prototype.receive = function (from, message, oobParams) {
  ...
  // ... to be overloaded
  console.warn("----------agent receive", from, message)
};
...
Agent.prototype.connect = function (transport, id) {
  // console.log("Agent.connect",transport)
...
Agent.prototype._connect = function (transport, id) {
  console.warn("------------------Agent._connect",transport)
  ...
  console.warn ("----------------Agent._connection",connection)
