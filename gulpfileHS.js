...
gulp.task('compress', gulp.series('babel'), function (cb) {
  pump([
...
gulp.task('watch', gulp.series('compress'), function () {
  livereload.listen();
  gulp.watch(['index.js', 'lib/**/*.js'], ['compress']);
});

gulp.task('bundle', gulp.series('babel'));
gulp.task('watch-bundle', gulp.series('babel'), function () {
  livereload.listen();
